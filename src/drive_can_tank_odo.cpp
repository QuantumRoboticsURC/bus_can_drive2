...
TalonSRX srxArmGripper(12);
TalonSRX srxArm1(11);
TalonSRX srxSwrvFL(17);
TalonSRX srxSwrvFr(14);
TalonSRX srxSwrvBl(16);
TalonSRX srxArm5(21); 
TalonSRX srxArm3(15); 
...
TalonFX talFrontRight(3);
TalonFX talBackLeft(1);//back  1-->2
TalonFX talBackRight(2);//back  2-->0
TalonFX talArm2(4);
...
srxArmGripper.ConfigFactoryDefault();
...
srxSwrvBr.SetInverted(true);

srxArm5.SetSensorPhase(false);
...
srxArmGripper.ConfigNominalOutputForward(0, 10);
srxArmGripper.ConfigNominalOutputReverse(0, 10);
srxArmGripper.ConfigPeakOutputForward(1, 10);
srxArmGripper.ConfigPeakOutputReverse(-1, 10);
...
srxArm5.Config_kF(0, 0, 10);
srxArm5.Config_kP(0, 2, 10); 
srxArm5.Config_kI(0, 0.0001, 10);
srxArm5.Config_kD(0, 55.2972973, 10);
srxArm5.ConfigMotionCruiseVelocity(9, 10);
srxArm5.ConfigMotionAcceleration(9, 10);

/* set closed loop gains in slot0, editar valor de en medio */ 
/* Set acceleration and vcruise velocity - see documentation */
srxSwrvFL.Config_kF(0, 34.1, 10);
srxSwrvFL.Config_kP(0, 6.2, 10); 
...
/* set closed loop gains in slot0, editar valor de en medio */ 
/* Set acceleration and vcruise velocity - see documentation */
srxSwrvFr.Config_kF(0, 34.1, 10);
srxSwrvFr.Config_kP(0, 6.2, 10); 
...
/* set closed loop gains in slot0, editar valor de en medio */ 
/* Set acceleration and vcruise velocity - see documentation */
srxArm3.Config_kF(0, 0, 10);
srxArm3.Config_kP(0, 3, 10); 
srxArm3.Config_kI(0, 0.00012, 10);
srxArm3.Config_kD(0, 0, 10);
srxArm3.ConfigMotionCruiseVelocity(9, 10);
srxArm3.ConfigMotionAcceleration(9, 10);

srxArm1.Config_kF(0, 0, 10);
srxArm1.Config_kP(0, 2, 10); 
srxArm1.Config_kI(0, 0.00005, 10);
srxArm1.Config_kD(0, 0.000, 10);
...
class Drive_can: public rclcpp::Node
{
    private:
        ...
        rclcpp::Subscription<std_msgs::msg::Float64>::SharedPtr joint3_;
		...
		rclcpp::Subscription<std_msgs::msg::Float64>::SharedPtr elevator_;
    ...
    public:
			...
			elevator_ =this->create_subscription<std_msgs::msg::Float64>("science/elevator", 10, std::bind(&Drive_can::elevator_callback, this, _1));
			...
			joint5_ =this->create_subscription<std_msgs::msg::Float64>("/arm_teleop/joint4", 10, std::bind(&Drive_can::joint5Callback, this, _1));
	...
	void elevator_callback(const std_msgs::msg::Float64::SharedPtr msg){
		ctre::phoenix::unmanaged::FeedEnable(10000); 
    		srxArm1.Set(ControlMode::PercentOutput, msg->data);
	}
	...
	void joint3Callback(const std_msgs::msg::Float64::SharedPtr msg) const{
		...
		/*4096 ticks/rev in either direction */
		/* input should be a value from -110 to 110 deg */
		if (msg->data >= -150 && msg->data <= 150){
		//int offset1_deg = 50.2734375 + 180; //Cero at  center
		//double targetPos = (msg.data + offset1_deg) * 4096 / 360;
		double targetPos = my_map(msg->data, -150, 150, 64, 3482);
	...
	void joint5Callback(const std_msgs::msg::Float64::SharedPtr msg) const{
		ctre::phoenix::unmanaged::FeedEnable(10000);  
		/* Motion Magic */     
		/*4096 ticks/rev in either direction */
		/* input should be a value from -110 to 110 deg */
		...
		//int offset1_deg = 50.2734375 + 180; //Cero at  center
		//double targetPos = (msg.data + offset1_deg) * 4096 / 360;
		double targetPos = my_map(-msg->data, -150, 150, 205, 3618);
		srxArm5.Set(ControlMode::MotionMagic, targetPos);
		//srxArm1.Set(ControlMode::PercentOutput, targetPos);

		/* Prepare line to print */
		std::stringstream sb;
		int dif_error = srxArm5.GetSelectedSensorPosition() - targetPos;
	...
	/*void frontleftCallback(const std_msgs::msg::Float64::SharedPtr msg) {
		...
		double targetPos = my_map(msg->data,-90,90, 682, 2730);  
	...
	void frontrightCallback(const std_msgs::msg::Float64::SharedPtr msg) {
		...
		if (msg->data >= -90 && msg->data <= 90){
			...
			//int out_max = 1515;
			//double targetPos = (x - in_min) * (out_max - out_min) / (in_max - in_min) + out_min;
		double targetPos = my_map(msg->data,-90 , 90, 1417, 3465);
	...
	void gripper_callback(const std_msgs::msg::Float64::SharedPtr msg){
		ctre::phoenix::unmanaged::FeedEnable(10000); 
    	srxArmGripper.Set(ControlMode::PercentOutput, msg->data);
